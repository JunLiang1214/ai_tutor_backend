...
def get_property_card(city_id,area_id=None, budget=None, purpose="buy", type="residential"):
    import requests
    import json
...
def get_property_data(city=None, area=None, budget=None, purpose="buy"):
    return [{'customTitle': 'House Available For Sale In G-9', 'price': 'Rs.77500000', 'id': 953497, 'size': '14 Marla', 'image': 'http://res.cloudinary.com/graanacom/image/upload/v1686206164/qacvhqhjfgphwjq2mmck.jpg', 'link': 'House-Available-For-Sale-In-G-9-953497'}, {'customTitle': 'House Available For Sale In G-9', 'price': 'Rs.85000000', 'id': 953481, 'size': '14 Marla', 'image': 'http://res.cloudinary.com/graanacom/image/upload/v1686206006/c30eawbdrh03lcsdihwf.jpg', 'link': 'House-Available-For-Sale-In-G-9-953481'}, {'customTitle': 'House Available For Sale In G-9', 'price': 'Rs.87000000', 'id': 953472, 'size': '14 Marla', 'image': 'http://res.cloudinary.com/graanacom/image/upload/v1686205843/janjcw9adcuy6y2dl8nt.jpg', 'link': 'House-Available-For-Sale-In-G-9-953472'}]
    ...
    response = get_property_card(city_id=city_id,area_id=area_id, budget=budget, purpose=purpose)
