...
functions = [
    ...
    },
    {
        ...
        "description":"find properties information. Only call IF USER HAS PROVIDED HIS NAME, City, Area, Budget and Purpose.",
        # "description":"find properties information. Only call IF USER HAS PROVIDED HIS NAME, City, Area, Budget and Purpose. Your response should begin as 'we have the following properties:'",
        "parameters":{
            "type":"object",
            "properties":{
                "city":{
            ...
            "required":["city","area","budget"]
        },
    },
 
    {
        "name": "get_price_estimate",
        "description":"Get estimated price of a house or properties. Response should be in Indian numbering system — lakh, crore and arab for example Rs 30,000,000 should be 3 crore. Currency is PKR",
        "parameters":{
            "type":"object",
            "properties":{
                "city":{
